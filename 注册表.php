		...
		<div>
			<h3 align="center">注册表</h3>
				...
				<p>
					...
					<?php echo $_GET["real_name"]; ?>		
				</p>
				<p>
					<span class="span1">真实年龄&nbsp;:</span>
					<?php echo $_GET["real_age"]; ?>		
				</p>
				...
				<p class="lucky">
     			...
     			<?php echo $_GET["lovecolor"]; ?>
     			<?php echo "<div style=\"width:50px;height:20px;margin-left:135px;background-color:$_GET[lovecolor];\"></div>";?>
				</p>
				<p>
